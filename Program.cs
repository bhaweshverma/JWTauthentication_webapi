    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.File(new RenderedCompactJsonFormatter(), "Logs\\jwtauthenticationapi.ndjson", 
                ...
                .WriteTo.File("Logs\\jwtauthenticationapi.txt", LogEventLevel.Debug, defaultOutputTemplate, 
